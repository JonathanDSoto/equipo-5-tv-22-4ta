                        ...
                        <div class="card-body pt-0">
                            <div>
                                <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active All py-3" data-bs-toggle="tab" id="All" href="#home1" role="tab" aria-selected="true">
                                            <i class="ri-store-2-fill me-1 align-bottom"></i>Directory
                                        </a>
                                    </li>
                                </ul>
                                <div class="table-responsive table-card mb-1">
                                  <table class="table table-nowrap align-middle" id="dTable">
                                    <thead class="text-muted table-light">
                                        <tr class="text-uppercase">
                                        
                                            
                                            <th class="sort" data-sort="cp">Postal Code</th>
                                            <th class="sort" data-sort="city_name">City</th>
                                            <th class="sort" data-sort="province_name">Province</th>
                                    ...
                                    <tbody class="list form-check-all">
                                        <tr>
                                            <td class="cp">23085</td>
                                            <td class="city_name">La Paz</td>
                                            <td class="province_name">Baja California Sur</td>
                                            <td class="phone_number">6243511982</td>
