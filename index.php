...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <a href="./products/index.php">CALANDOLE</a>
                                </div>
                            </div>
                            <!-- end card body -->
                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Don't have an account ? <a href="./users/singup.php" class="fw-semibold text-primary text-decoration-underline"> Signup </a> </p>
                        </div>
    ...
    <!-- particles js -->
    <script src="public/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
